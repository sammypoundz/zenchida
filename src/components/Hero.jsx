      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div>
              <motion.h1 
                className="text-6xl lg:text-7xl font-bold leading-tight text-gray-900 dark:text-white"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 my-8 leading-relaxed">
