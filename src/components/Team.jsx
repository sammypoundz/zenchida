...
const Team = () => {
  ...
  return (
    <section id="team" className="py-32 relative overflow-hidden">
      ...
      {/* Floating orbs with reduced opacity in light mode */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-primary/10 dark:bg-primary/20 rounded-full filter blur-3xl animate-pulse-slow" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-redAccent/10 dark:bg-redAccent/20 rounded-full filter blur-3xl animate-pulse-slow" />
        ...
        >
          {teamMembers.map((member, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 flex flex-col items-center justify-center text-center border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-shadow"
                style={{
              ...
              >
                <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-primary/30 mb-4 ring-2 ring-primary/20 group-hover:border-primary transition-all duration-300">
                  <img
                    src={member.avatar}
                    alt={member.name}
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/10 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-primary hover:text-white transition-colors"
                  >
